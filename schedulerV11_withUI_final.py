...
def loadFiles(self, courses, location):
    ...
    try:
        ...
        # Attempting to read in course file
        currentFile = courses
        ...
        # Attempting to read in location file
            ...
            if(len(class_arr) > 0) and (len(course_arr) > 0):
                ...
                if(caughtException == True):
                 ...
                 # Are the lists empty?
                    ...
                    self.class_results_window.setText(error + noDataErrorInst + s 
                                                      + emptyFile + s + formatErrorInst)
